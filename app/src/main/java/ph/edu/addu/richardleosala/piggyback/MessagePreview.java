...
public class MessagePreview extends AppCompatActivity {
    ListView prevMessage;
    ...
    private void initialWork() {
        ...
        //mReceiver=new WiFiDirectBroadcastReceiver(mManager, mChannel, MessagePreview.this);
